...
".##...#.#.###....##..##..#.#.#.#.#..#..##.###...####..#..#.#.#.#####..##.#.#.##.##...#.....#...###.#";
            ...
            Console.WriteLine("Part 1 Result: " + EnhanceN(input, 2).Count(x => x.Value == 1));
            Console.WriteLine("Part 2 Result: " + EnhanceN(input, 50).Count(x => x.Value == 1));
            ...
            Dictionary<Point, int> EnhanceN(string input, int n)
            {
                ...
                var (minX, minY, maxX, maxY) = (0, 0, image.Keys.Max(p => p.x), image.Keys.Max(p => p.y));
